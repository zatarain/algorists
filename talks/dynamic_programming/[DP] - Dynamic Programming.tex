...
\begin{frame}{Coin change (brainstorming)}
...
\begin{frame}{David's staircase (brainstorming)}
...
\begin{frame}{David's staircase (brainstorming)}
\begin{exampleblock}{David's staircase (\href{https://www.hackerrank.com/challenges/ctci-recursive-staircase/problem}{source: HackerRank})}
For example, there is $s=1$ staircase in the house that is $n=5$
steps high. David can step on the following sequences of steps:
\end{exampleblock}
\end{frame}
